...
# Install system dependencies including HiGHS solver
...
# Install HiGHS solver for better LP performance (optional but recommended)
# If installation fails, CBC will be used as fallback
RUN pip install --no-cache-dir highspy || echo "HiGHS installation failed, will use CBC solver"
