...
class ExperimentConfig:
    ...
    # LP parameters
    lp_price_grid_size: int = 5  # Number of discrete price levels (linear spacing from 0 to 2×trip_amount)
    lp_solver: str = 'cbc'  # LP solver: 'cbc' (default), 'highs' (faster if available), 'gurobi', 'cplex'
